...
public class UpdateConcurrencyViolationException : IcsException
{
    ...
    public UpdateConcurrencyViolationException(string tableName, DbUpdateException innerException) :
    ...
    public override string ErrorMessage => Exceptions.Resources.ErrorMessage.UpdateConcurrencyViolation;
}

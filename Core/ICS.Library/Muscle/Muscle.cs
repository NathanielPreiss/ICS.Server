...
public class Muscle
{
    ...
    public static readonly IReadOnlyDictionary<MuscleTypes, Muscle> Lookup;
    public static readonly IReadOnlyCollection<Muscle> Values;

    internal static readonly IReadOnlyDictionary<MuscleGroupTypes, IReadOnlyCollection<Muscle>> MuscleGroupMap;

...
public class JointMuscleGroupMap
{
    ...
    public static IReadOnlyList<JointMuscleGroupMap> Values { get; }

    internal static IReadOnlyDictionary<MuscleGroupTypes, IReadOnlyCollection<Joint>> MuscleGroupMap { get; }
    internal static IReadOnlyDictionary<JointTypes, IReadOnlyCollection<MuscleGroup>> JointMap { get; }

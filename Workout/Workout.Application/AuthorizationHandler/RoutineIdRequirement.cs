...
/// 
/// </summary>
public class RoutineIdRequirement : IAuthorizationRequirement
{
}
/// <summary>
/// 
/// </summary>
public class RoutineIdRequirementHandler : AuthorizationHandler<RoutineIdRequirement>
{
    private readonly IDbContextFactory<WorkoutDbContext> _dbContextFactory;
    private readonly ILogger<RoutineIdRequirementHandler> _logger;
    private const string RoutineIdKey = "routineId";
    private const string MemberRoleKey = "Member";

    public RoutineIdRequirementHandler(
        IDbContextFactory<WorkoutDbContext> dbContextFactory,
        ILogger<RoutineIdRequirementHandler> logger)
    {
    ...
    protected override async Task HandleRequirementAsync(
        ...
        RoutineIdRequirement requirement)
    {
